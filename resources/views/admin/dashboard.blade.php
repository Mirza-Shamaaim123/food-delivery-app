					...
					<div class="col-xl-6 col-lg-12">
						<div class="card">
							<div class="card-header border-0 d-sm-flex d-block">
								...
								<div class="card-action card-tabs mt-3 mt-sm-0  mt-sm-0">
								...
								<div class="table-responsive ">
									<table class="table order-request">
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="me-3 img-fluid rounded-circle" width="75" src="{{ asset('dashboard_assets/images/card/pic1.jpg') }}" alt="DexignZone">
													<div class="media-body">
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="me-3 img-fluid rounded-circle" width="75" src="{{ asset('dashboard_assets/images/card/pic2.jpg') }}" alt="DexignZone">
													<div class="media-body">
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="me-3 img-fluid rounded-circle" width="75" src="{{ asset('dashboard_assets/images/card/pic3.jpg') }}" alt="DexignZone">
													<div class="media-body">
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="me-3 img-fluid rounded-circle" width="75" src="{{ asset('dashboard_assets/images/card/pic6.jpg') }}" alt="DexignZone">
													<div class="media-body">
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="me-3 img-fluid rounded-circle" width="75" src="{{ asset('dashboard_assets/images/card/pic7.jpg') }}" alt="DexignZone">
													<div class="media-body">
														<h5 class="mt-0 mb-2"><a href="ecom-product-detail.html" class="text-black">Mozarella Pizza With Random Topping</a></h5>
														<p class="mb-0 text-primary">#0010299</p>
													</div>
								...
								<div class="widget-media trending-menus">
									<ul class="timeline">
										<li>
											<div class="timeline-panel">
												<div class="media me-3">
													<img alt="image" width="90" src="{{ asset('dashboard_assets/images/card/pic8.jpg') }}">
										...
										<li>
											<div class="timeline-panel">
												<div class="media me-3">
													<img alt="image" width="90" src="{{ asset('dashboard_assets/images/card/pic4.jpg') }}">
										...
										<li>
											<div class="timeline-panel">
												<div class="media me-3">
													<img alt="image" width="90" src="{{ asset('dashboard_assets/images/card/pic9.jpg') }}">
										...
										<li>
											<div class="timeline-panel">
												<div class="media me-3">
													<img alt="image" width="90" src="{{ asset('dashboard_assets/images/card/pic6.jpg') }}">
										...
										<li>
											<div class="timeline-panel">
												<div class="media me-3">
													<img alt="image" width="90" src="{{ asset('dashboard_assets/images/card/pic10.jpg') }}">
