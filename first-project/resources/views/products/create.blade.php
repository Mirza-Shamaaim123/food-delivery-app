            ...
            <div class="card borrder-0 shadow-lg my-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{old('name')}}" class=" @error('name') is-invalid @enderror form-control form-control-lg" placeholder="Enter Product Name" name="name">
                        @error('name')
                     ...
                     <div class="mb-3">
                        ...
                        <input type="text" value="{{old('price')}}" class="  @error('price') is-invalid @enderror form-control form-control-lg" placeholder="Enter price" name="price">
                          @error('price')
                        <p class="invalid-feedback">{{$message}}</p>
                        @enderror
                    </div>
